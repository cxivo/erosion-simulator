...
{
    public class PipeModelSimulator : Simulator
    {
        ...
        public PipeModelSimulator(int sizeX, int sizeY, TerrainProvider terrainProvider)
        {
            this.SizeX = sizeX;
            this.SizeY = sizeY;
            ...
            for (int x = 0; x < SizeX; x++)
            {
                for (int y = 0; y < SizeY; y++)
                {
                    if (water[x, y].Height > 0d)
                    {
                        ...
                        water[x, y].Velocity = flowVelocity / CELL_SIZE; // * 0.5d * (water[x, y].Height + water[x, y].PreviousHeight));                        
