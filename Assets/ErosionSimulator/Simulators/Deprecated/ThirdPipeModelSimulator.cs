...
{
    public class ThirdPipeModelSimulator : Simulator
    {
        ...
        public ThirdPipeModelSimulator(int sizeX, int sizeY, TerrainProvider terrainProvider)
        {
            this.SizeX = sizeX;
            this.SizeY = sizeY;
                    ...
                    {                        
                        ...
                        for (int i = 0; i < 4; i++)
                        {
                            if (isInBounds(x + deltaX[i], y + deltaY[i]))
                            {
                                ...
                                double erodeableHeight = Math.Max(0d, terrain[x + deltaX[i], y + deltaY[i]] - terrain[x, y]);
                                ...
                                double sedimentHeight = Math.Min((flow / (CELL_SIZE * CELL_SIZE)) * slope * DELTA_T * COLLISION_EROSION_CONSTANT, erodeableHeight);
